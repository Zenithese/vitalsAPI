...
class MeasurementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create measurement" do
    assert_difference('Measurement.count') do
      post measurements_url, params: { measurement: { blood: @measurement.blood, oximeter_pr: @measurement.oximeter_pr, oximeter_spo2: @measurement.oximeter_spo2, temperature: @measurement.temperature } }
    end
  ...
  test "should update measurement" do
    patch measurement_url(@measurement), params: { measurement: { blood: @measurement.blood, oximeter_pr: @measurement.oximeter_pr, oximeter_spo2: @measurement.oximeter_spo2, temperature: @measurement.temperature } }
